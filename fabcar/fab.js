...
function third(fncnName,argsArr) {
...
function sixth(params) {
    console.error('Failed to invoke successfully :: ' + err);
}
module.exports={init:init,first:first,second:second,third:third,fourth:fourth,fifth:fifth,sixth:sixth};